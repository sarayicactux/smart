...
<br/>
        ...
        <div  align="left">
            ...
            <ul class="nav" style="left:35px; position:absolute;">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span style="color:#ffffff"> {{ Auth::user()->name }} خوش آمدید<span class="caret"></span></a>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" onclick="postMenus('admin/partners');" >نمایندگان وب</a>
                </li>
                <li class="dropdown">
                    <a href="#" onclick="postMenus('admin/allUrls');" >نشانی های وب</a>
                </li>
                <li class="dropdown">
